        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                        ...
                        <tbody>
                            @foreach ($applications as $application)
                                <tr class="bg-white hover:bg-gray-50 transition">
                                    ...
                                    <!-- Product Details -->
                                    @if($application->products) <!-- Check if the application has a product associated -->
                                        <td class="py-3 px-4 border border-gray-300">{{ $products->product_id->product_name }}</td>
                                        <td class="py-3 px-4 border border-gray-300">{{ $products->category->category_name }}</td>
                                    @else
                                        <td class="py-3 px-4 border border-gray-300">N/A</td>
                                        <td class="py-3 px-4 border border-gray-300">N/A</td>
                                    @endif
                    ...
                    <!-- Pagination -->
                    <div class="mt-4">
                        {{ $applications->links() }} <!-- Pagination links for the applications -->
                    </div>
                </div>
            </div>
        </div>
