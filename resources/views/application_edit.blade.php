                    ...
                    <table class="min-w-full table-auto">
                        <thead>
                            <tr class="bg-gray-100 text-gray-700">
                                ...
                                <th class="py-3 px-4 border border-gray-300 text-left">Category</th>
                        ...
                        <tbody>
                            @foreach ($applicationedit as $application)
                                <tr class="bg-white hover:bg-gray-50 transition">
                                    ...
                                    <!-- Product Details -->
                                    @if($application->product) <!-- Check if the application has a product associated -->
                                        <td class="py-3 px-4 border border-gray-300">{{ $application->product->product_name }}</td>
                                        <td class="py-3 px-4 border border-gray-300">{{ $application->product->category->category_name }}</td>
                                    @else
                                        <td class="py-3 px-4 border border-gray-300">No product</td>
                                        <td class="py-3 px-4 border border-gray-300">No category</td>
                                    @endif
