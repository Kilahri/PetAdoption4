...
class ApplicationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $application = Application::with('product')->get();
        
        

        // Combine the two collections (though this might need further processing depending on your needs)
        return view('applications', compact('applications', 'application'));
    }
